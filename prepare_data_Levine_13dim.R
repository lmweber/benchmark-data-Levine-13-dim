...
# 
# This data set is a 13-dimensional mass cytometry (CyTOF) data set, consisting of
# expression levels of 13 surface marker proteins. Cluster labels are available for 24
# manually gated cell populations. Cells are healthy human bone marrow mononuclear cells
# (BMMCs), from 1 individual.
#
